"""
Minimal test for DroneMissionEnv WITH PATH

GOAL:
- Spawn on ground
- Gentle takeoff
- Transition to trajectory following
- NO dropout
...
def main():
    ...
    print("Mission test (with path) started. Steps:", steps)
    ...
    for k in range(steps):
        ...
        # Debug
        if k % 100 == 0:
            print(f"t={t:.2f}s  z={x[2]:.3f}  path={path_active}")
